  ...
  self.make = function(stepdef) {
    ...
    if( !stepclass ) {
      ...
      if( macro ) {
        ...
        var stepdefopt = _.clone(stepdef)
        delete stepdefopt.opt
        delete stepdefopt.name
        delete stepdefopt.macro
        stepdefopt = _.extend(stepdefopt,stepdef.opt||stepdef.opts||{})

        stepdef.opt = {macro:stepdef.name,argopt:stepdefopt}
      }
    }
