...
/* need a step that decl defines expected arg combos */
      ...
      build_ios: {steps:[
        ...
        { name: "block", "if": "arg.archive", steps:[
            ...
            { name: "block", "if": "arg.testflight", steps:[
              { name: 'exec',
                  opt: { buildscript: require.resolve('./../bin/testflight-ios.sh') },
                  cmd: '${opt.buildscript+" \\""+arg.outputdir+"\\" \\""+arg.target+"\\" \\""+arg.testflight_teamtoken+"\\" \\""+arg.testflight_apitoken+"\\" \\""+arg.testflight_notify+"\\" \\""+arg.testflight_distributionlists+"\\""}'
              }
            ]}
        ]}
      ]},
